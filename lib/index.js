...
class OSSimulator {
  ...
  async displayOutput(operation, binary1, binary2, result) {
    printSeparator('80%: System Ready');
    print(`Operation: ${operation}`, 'yellow');
    print(`Input A: ${binary1}`, 'yellow');
    print(`Input B: ${binary2}`, 'yellow');
    print(`Result: ${result}`, 'yellow');
    print('System fully operational!', 'green');
    await this.logger.logOperation('System fully booted');
    setProgress(80);
  }
  ...
  async run() {
    ...
    await this.displayOutput(operation, binary1, binary2, result);
